...
(function () {
    ...
    function setup({ buttonId, getContext: contextGetter }) {
    ...
    async function exportActiveTab(button) {
        ...
        try {
            ...
            await generatePdf(report.element, report.fileName);
        } catch (error) {
    ...
    function buildReport(context) {
        ...
        const fileName = `relatorio-estacao-${slug(tabConfig.label)}-${selectedDate}.pdf`;
        ...
        return { element: report, fileName };
    }
